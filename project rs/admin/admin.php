...
<h2 class="text-center  wowload fadeInUp" style="color: orange; text-shadow: 2px 2px yellow;font-size: 60px;">Reservation</h2>
  <div class="row wowload fadeInLeftBig">      
      <div class="col-sm-6 col-sm-offset-3 col-xs-12">      
        <input type="text" placeholder="Name" style="font-size: 30px;color: yellowgreen;">
        <input type="text" placeholder="Company"style="font-size: 30px;color: yellowgreen;">
        <textarea rows="5" placeholder="Message"style="font-size: 30px;color: yellowgreen;"></textarea>
